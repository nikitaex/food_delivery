...
from .views import RestaurantViewSet, MealViewSet, OrderViewSet, RestaurateurViewSet, ComplaintViewSet
...
router.register('restaurateur', RestaurateurViewSet, basename='restaurateur')
